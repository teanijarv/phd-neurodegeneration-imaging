...
from connectomics import connectivity
from utils import io, transform
...
def calculate_betw_centrality(connectome_path, fisher=False, standardise=False, drop_first_roi=False, 
                              not_negative=False, replace_nan_with=None, mask=None, percentile=90,
                              verbose=False):
    """Calculate betweenness centrality of the thresholded connectome."""
    ...
    connectome_bin = get_percentile_mask(connectome, percentile)

    return bct.betweenness_bin(connectome_bin)

def calculate_clustering_coef(connectome_path, fisher=False, standardise=False, drop_first_roi=False, 
                              not_negative=False, replace_nan_with=None, mask=None, percentile=90,
                              verbose=False):
    """Calculate clustering coefficient of the thresholded connectome."""
    ...
    return bct.clustering_coef_bu(connectome_bin)

def calculate_efficiency(connectome_path, fisher=False, standardise=False, drop_first_roi=False, 
                              not_negative=False, replace_nan_with=None, mask=None, percentile=90,
                              verbose=False):
    """Calculate clustering coefficient of the thresholded connectome."""
    ...
    return bct.efficiency.efficiency_bin(connectome_bin, local=True)