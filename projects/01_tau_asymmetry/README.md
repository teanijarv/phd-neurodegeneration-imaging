...
To access these analyses and install the required dependencies:
```
git clone https://github.com/teanijarv/phd-neurodegeneration-imaging.git
cd phd-neurodegeneration-imaging/projects/01_tau_asymmetry
```
...
uv sync
```
For Jupyter support or use in VSCode/VSCodium, activate and install kernel:
```
source .venv/bin/activate
python -m ipykernel install --user --name=01_tau_asymmetry --display-name "01_tau_asymmetry"
```
